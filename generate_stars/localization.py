...
ENGLISH_DEFAULT_TEXTS = {
    ...
    "text.trash_note": "Trash stars are sampled from an automatic bounding box around all clusters, must stay within the requested min/max edge-distance band, and can keep a minimum spacing from each other.",
...
TRANSLATIONS = {
    "en": {
        **ENGLISH_DEFAULT_TEXTS,
        ...
        "ui.help": "Help",
        "ui.config": "Config",
        "ui.open_project_folder": "Open Project Folder",
        "ui.project_configs": "Project Configs",
        "ui.project_folder_value": "Folder: {folder}",
        ...
        "ui.label.min": "Min",
        "ui.label.max": "Max",
        "ui.label.parameter_mode": "Mode",
        "ui.label.parameter_function_body": "Function body",
        "ui.label.parameter_function_editor": "Function editor",
        "ui.label.parameter_preview": "Preview:",
        ...
        "ui.label.min_trash_star_distance": "Min distance between trash stars",
        "ui.option.equal": "Equal",
        "ui.option.deviation": "Deviation",
        "ui.option.manual": "Manual",
        "ui.option.parameter_random": "Random",
        "ui.option.parameter_function": "Function",
        "ui.button.edit_parameter_function": "Open editor",
        "ui.parameter_preview_value": "{value}",
        "ui.window.parameter_function_editor_title": "Parameter Function Editor",
        ...
        "status.project_opened": "Opened project {folder} ({count} configs).",
        "status.project_opened_no_configs": "Opened project {folder}, no project configs found.",
        ...
        "window.open_project_folder_dialog_title": "Open Project Folder",
        ...
        "error.trash_star_distance_negative": "Trash star minimum distance between trash stars cannot be negative.",
        ...
        "error.parameter_function_invalid": "Parameter function is invalid.",
        "error.parameter_function_runtime": "Parameter function failed during generation.",
        "error.parameter_function_return_type": "Parameter function must return string.",
        "error.parameter_string_token_invalid": "Parameter value must be non-empty string without whitespace.",
        ...
        "error.trash_placement_failed": "Could not place all trash stars with the requested edge-distance band and trash-star spacing. Reduce the trash-star count or relax distance constraints.",
        ...
        "error.project_folder_invalid": "Selected project folder is invalid.",
        "error.project_not_open": "No project folder is open.",
        "error.project_config_missing": "Selected project config does not exist in open project folder.",
        "error.project_no_active_config": "No active project config selected.",
    ...
    "ru": {
        ...
        "text.trash_note": "Мусорные звезды выбираются из автоматической ограничивающей области вокруг всех кластеров, должны попадать в заданный диапазон мин/макс расстояния от края и могут иметь минимальный отступ друг от друга.",
        ...
        "ui.help": "Справка",
        "ui.config": "Конфиг",
        "ui.open_project_folder": "Открыть папку проекта",
        "ui.project_configs": "Конфиги проекта",
        "ui.project_folder_value": "Папка: {folder}",
        ...
        "ui.label.min": "Мин",
        "ui.label.max": "Макс",
        "ui.label.parameter_mode": "Режим",
        "ui.label.parameter_function_body": "Тело функции",
        "ui.label.parameter_function_editor": "Редактор функции",
        "ui.label.parameter_preview": "Предпросмотр:",
        ...
        "ui.label.min_trash_star_distance": "Мин. расстояние между мусорными звездами",
        "ui.option.equal": "Равномерно",
        "ui.option.deviation": "С отклонением",
        "ui.option.manual": "Вручную",
        "ui.option.parameter_random": "Случайный",
        "ui.option.parameter_function": "Функция",
        "ui.button.edit_parameter_function": "Открыть редактор",
        "ui.parameter_preview_value": "{value}",
        "ui.window.parameter_function_editor_title": "Редактор функции параметра",
        "ui.option.y_of_x": "y = f(x)",
        "ui.option.x_of_y": "x = f(y)",
        "shape.circle": "Круг",
        ...
        "status.project_opened": "Открыт проект {folder} (конфигов: {count}).",
        "status.project_opened_no_configs": "Открыт проект {folder}, конфиги проекта не найдены.",
        ...
        "window.open_project_folder_dialog_title": "Открыть папку проекта",
        ...
        "error.trash_star_distance_negative": "Минимальное расстояние между мусорными звездами не может быть отрицательным.",
        ...
        "error.parameter_function_invalid": "Функция параметра некорректна.",
        "error.parameter_function_runtime": "Функция параметра завершилась ошибкой во время генерации.",
        "error.parameter_function_return_type": "Функция параметра должна возвращать строку.",
        "error.parameter_string_token_invalid": "Значение параметра должно быть непустой строкой без пробельных символов.",
        ...
        "error.trash_placement_failed": "Не удалось разместить все мусорные звезды с заданным диапазоном расстояний от края и минимальным расстоянием между мусорными звездами. Уменьшите число мусорных звезд или ослабьте ограничения расстояния.",
        ...
        "error.project_folder_invalid": "Выбранная папка проекта некорректна.",
        "error.project_not_open": "Папка проекта не открыта.",
        "error.project_config_missing": "Выбранный конфиг отсутствует в открытой папке проекта.",
        "error.project_no_active_config": "Активный конфиг проекта не выбран.",
