...
class TrashPanelView(PanelView):
    def __init__(self, config: AppConfig, attach_continuous_history: Callable[[Gtk.Widget], None]) -> None:
        super().__init__("Trash Stars", config)
        ...
        self.append(self.build_row("Trash star count", self.trash_count_spin))
        ...
        self.append(self.build_row("Min edge distance", self.trash_distance_spin))
